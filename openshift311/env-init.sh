...
ssh root@host01 'curl -skSL https://github.com/storageos/go-cli/releases/download/1.3.0/storageos_linux_amd64 > /usr/local/bin/storageos && chmod +x /usr/local/bin/storageos'
